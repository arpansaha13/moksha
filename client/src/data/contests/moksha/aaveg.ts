...
export const aaveg: Contest[] = [
    {
        ...
        instructions: [
            ...
            {
                ul: ['This is an individual event with a minimum age of 14 year and will take place in 2 rounds.',
                    ...
                    'If a participant exceeds the stipulated time, 15% of the total marks obtained will be deducted. If he/she exceeds 6 min, he/she stands to be debarred from thevevent.',
...

    {
        ...
        instructions: [
            ...
            {
                ul: ['This is a team event with a minimum age of 14 years and will take place in 2 rounds.',
...

    {
        ...
        instructions: [
            ...
            {
                ul: ['Participants will draw random chits from a jar of situations.',
...

    {
        ...
        instructions: [
            ...
            {
                ul: ['Only participants above a certain age (usually 12 or older) should take part, as younger children may not fully understand the risks.',
            ...
            {
                ul: ['The participants will go 1v1.',
...

    {
        ...
        instructions: [
            ...
            {
                ul: ['This game requires a single participant or a group (2 or more than 2 but not more than 6 people).',
