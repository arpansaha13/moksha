  ...
  return (
    <Sheet className='p-4 sm:p-6'>
      <form ref={formRef} onSubmit={createTeam}>
        <h2 className='text-2xl font-bold text-gray-50'>Create team</h2>
        ...
        <div className='mt-4'>
          ...
          >
            ...
            <span className='inline-block ml-2 text-gray-400'>Add team members</span>
          </button>
        </div>

        <Modal open={modalOpen} setOpen={setModalOpen}>
          <Dialog.Title className='mb-4 text-base lg:text-xl text-white font-semibold'>Add team members</Dialog.Title>
